      ...
      <div className="bg-white rounded-[2rem] p-6 w-full max-w-sm shadow-2xl">
        ...
        <div className="flex gap-3 mt-6">
          ...
          <button
            ...
            disabled={uploading}
            className="flex-1 py-3 rounded-xl font-bold text-white bg-[#FF385C] hover:bg-[#E31C5F] transition text-sm flex items-center justify-center gap-2 disabled:opacity-60"
          >
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8" dir="rtl">
      ...
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          <h1 className="text-xl font-bold text-zinc-900">الملف الشخصي</h1>
          <p className="text-xs text-zinc-400 font-medium">عدّل بياناتك وشعارك</p>
        </div>
      </div>
              ...
              <div className="relative">
                <div className="w-24 h-24 rounded-full border-2 border-slate-200 bg-slate-50 overflow-hidden flex items-center justify-center shadow-sm">
                  {form.office_logo_url ? (
                    ...
                    <span className="text-3xl font-bold text-[#FF385C]/30">{initials}</span>
                  )}
                </div>
                <label className="absolute bottom-0 left-0 w-8 h-8 rounded-full bg-[#FF385C] text-white flex items-center justify-center cursor-pointer hover:bg-[#E31C5F] transition shadow-md">
                  <Camera className="w-4 h-4" />
                  <input type="file" accept="image/*" className="hidden" onChange={handleFileSelect} />
                </label>
              </div>
              <p className="text-sm font-bold text-slate-700 mt-3">{form.full_name || 'بدون اسم'}</p>
              <p className="text-[11px] text-zinc-400 font-medium">{isAgent ? 'شعار المكتب' : 'شعار الشاليه'}</p>
