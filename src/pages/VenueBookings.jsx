...
import {
  ...
  FileText, Eye, Download, MapPin, QrCode, Crown
} from 'lucide-react';
...
export default function VenueBookings() {
  ...
  return (
    <div dir="rtl" className="min-h-screen bg-[#F7F7F7] font-sans pb-20 relative overflow-x-hidden text-zinc-950">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-5 lg:px-8">
        ...
        <div className="space-y-6 pb-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={() => canUsePaidFeatures(user) ? setShowManual(true) : setShowPaidHint(true)}
      ...
      {showPaidHint && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4" onClick={() => setShowPaidHint(false)}>
          ...
          <div dir="rtl" onClick={e => e.stopPropagation()}
            ...
            <div className="w-14 h-14 rounded-2xl mx-auto mb-4 flex items-center justify-center" style={{ background: '#FF385C15' }}>
              <Crown className="w-7 h-7" style={{ color: '#FF385C' }} />
            </div>
