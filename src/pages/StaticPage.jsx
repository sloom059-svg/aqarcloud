...
const pages = {
  terms: {
    ...
    sections: [
      { title: 'استخدام المنصة', body: 'تُستخدم عقار كلاود لإنشاء وتصميم جرافيكس لصفحات عرض وإدارة العقارات والأماكن والحجوزات. يلتزم المستخدم بإدخال معلومات صحيحة ومحدثة عن المكتب أو العقار أو المكان المعروض.' },
...
export default function StaticPage({ type = 'about' }) {
  ...
  return (
    <div className="min-h-screen bg-[#F7F7F7] text-zinc-900" dir="rtl" style={OFFICIAL_FONT}>
